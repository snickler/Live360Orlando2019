...
namespace IdentityDemo_Scaffolding.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_userManager.SupportsUserTwoFactorRecoveryCodes)
            {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(SqlIdentityUser user)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Identity Demo"),
